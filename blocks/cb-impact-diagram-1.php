			...
			<div class="col-md-3 cb-impact-diagram-1__card-wrap" data-cid-row="1">
				<div class="cb-impact-diagram-1__card">
					...
					<div class="cb-impact-diagram-1__card-icon">
						<?php if ( $icon_path && preg_match( '/\.svg$/i', $icon_path ) && file_exists( $icon_path ) ) : ?>
						...
						<?php else : ?>
						<?= wp_get_attachment_image( $icon, 'medium' ); ?>
						<?php endif; ?>
					</div>
					<?php endif; ?>
					<div class="cb-impact-diagram-1__card-stat">
						<?php if ( $stat_prefix ) : ?><span class="cb-impact-diagram-1__card-stat-prefix"><?= esc_html( $stat_prefix ); ?></span><?php endif; ?>
						<?php if ( $stat ) : ?><span class="cb-impact-diagram-1__card-stat-number" data-stat-target="<?= esc_attr( $stat ); ?>">0</span><?php endif; ?>
						<?php if ( $stat_suffix ) : ?><span class="cb-impact-diagram-1__card-stat-suffix"><?= esc_html( $stat_suffix ); ?></span><?php endif; ?>
					</div>
					<?php if ( $content ) : ?>
