	...
	*/
	...
	function requireCustomJavascript () {
		...
		(function () {
		  ...
		  var ANIMATIONS = new Set(['fade', 'fade-up', 'fade-down', 'fade-left', 'fade-right', 'fade-up-right', 'fade-up-left', 'fade-down-right', 'fade-down-left', 'flip-up', 'flip-down', 'flip-left', 'flip-right', 'slide-up', 'slide-down', 'slide-left', 'slide-right', 'zoom-in', 'zoom-in-up', 'zoom-in-down', 'zoom-in-left', 'zoom-in-right', 'zoom-out', 'zoom-out-up', 'zoom-out-down', 'zoom-out-left', 'zoom-out-right']);
		...
		(function () {
		  ...
		  const formatValue = (element, value) => {
		    ...
		    const fmt = typeof Intl !== "undefined" && Intl.NumberFormat ? new Intl.NumberFormat() : {
		      format: n => String(n)
		    };
		  ...
		  const startValue = element => {
		    ...
		    const aosDelay = delayHost ? parseInt(delayHost.getAttribute("data-aos-delay"), 10) || 0 : 0;
		  ...
		  const observer = new IntersectionObserver((entries, obs) => {
		    entries.forEach(entry => {
		      ...
		      entry.target.querySelectorAll(".stat-hero__stat-value, .cb-stats__stat-value, .cb-ticker-x3__stat-value").forEach(startValue);
		...
		(function () {
		  ...
		  var blocks = Array.prototype.slice.call(document.querySelectorAll(".cb-feature-title"));
		  ...
		  blocks.forEach(function (block) {
		    ...
		    if (groups.length && prev && prev.classList.contains("cb-feature-title")) {
		  ...
		  groups.forEach(function (group) {
		    var targets = group.map(function (b) {
		    ...
		    ScrollTrigger.create({
		      ...
		      onEnter: function () {
		        gsap.to(targets, {
		          ...
		          ease: "power2.out",
		          stagger: 0.15,
		          // resets per group — each group is its own tween
		          overwrite: true
		        });
		      }
		    });
