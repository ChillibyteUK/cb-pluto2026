	...
	if ( function_exists( 'acf_register_block_type' ) ) {
		...
		acf_register_block_type(
			array(
				...
				'title'           => __( 'CB Report Pushthrough' ),
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-report-pushthrough.php',
				'mode'            => 'edit',
				'supports'        => array(
					'mode'      => false,
					'anchor'    => true,
		...
		acf_register_block_type(
			array(
				'name'            => 'cb_lead_contacts',
				'title'           => __( 'CB Lead Contacts' ),
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-lead-contacts.php',
				'mode'            => 'edit',
				'supports'        => array(
					'mode'      => false,
					'anchor'    => true,
		...
		acf_register_block_type(
			array(
				'name'            => 'cb_recycling_private_debt',
				'title'           => __( 'CB Recycling Private Debt' ),
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-recycling-private-debt.php',
				'mode'            => 'edit',
				'supports'        => array(
					'mode'      => false,
					'anchor'    => true,
		...
		acf_register_block_type(
			array(
				'name'            => 'cb_stat_bar',
				'title'           => __( 'CB Stat Bar' ),
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-stat-bar.php',
				'mode'            => 'edit',
				'supports'        => array(
					'mode'      => false,
					'anchor'    => true,
		...
		acf_register_block_type(
			array(
				'name'            => 'cb_collapse',
				'title'           => __( 'CB Collapse' ),
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-collapse.php',
				'mode'            => 'edit',
				'supports'        => array(
					'mode'      => false,
					'anchor'    => true,
		...
		acf_register_block_type(
			array(
				'name'            => 'cb_markets_map',
				'title'           => __( 'CB Markets Map' ),
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-markets-map.php',
				'mode'            => 'edit',
				'supports'        => array(
					'mode'      => false,
					'anchor'    => true,
		...
		acf_register_block_type(
			array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-accordion-tabs.php',
				'mode'            => 'edit',
				'supports'        => array(
					'mode'      => false,
					'anchor'    => true,
		...
		acf_register_block_type(
			array(
				'name'            => 'cb_contact_full',
				'title'           => __( 'CB Contact Full' ),
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-contact-full.php',
				'mode'            => 'edit',
				'supports'        => array(
					'mode'      => false,
					'anchor'    => true,
		...
		acf_register_block_type(
			array(
				'name'            => 'cb_team_simple',
				'title'           => __( 'CB Team Simple' ),
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-team-simple.php',
				'mode'            => 'edit',
				'supports'        => array(
					'mode'      => false,
					'anchor'    => true,
		...
		acf_register_block_type(
			array(
				'name'            => 'cb_card_grid',
				'title'           => __( 'CB Card Grid' ),
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-card-grid.php',
				'mode'            => 'edit',
				'supports'        => array(
					'mode'      => false,
					'anchor'    => true,
		...
		acf_register_block_type(
			array(
				'name'            => 'cb_text_definition',
				'title'           => __( 'CB Text Definition' ),
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-text-definition.php',
				'mode'            => 'edit',
				'supports'        => array(
					'mode'      => false,
					'anchor'    => true,
		...
		acf_register_block_type(
			array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-bg-text-repeater.php',
				'mode'            => 'edit',
				'supports'        => array(
					'mode'      => false,
					'anchor'    => true,
		...
		acf_register_block_type(
			array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-two-col-checklist.php',
				'mode'            => 'edit',
				'supports'        => array(
					'mode'      => false,
					'anchor'    => true,
		...
		acf_register_block_type(
			array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-portfolio-index.php',
				'mode'            => 'edit',
				'supports'        => array(
					'mode'      => false,
					'anchor'    => true,
		...
		acf_register_block_type(
			array(
				'name'            => 'cb_insights_index',
				'title'           => __( 'CB Insights Index' ),
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-insights-index.php',
				'mode'            => 'edit',
				'supports'        => array(
					'mode'      => false,
					'anchor'    => true,
